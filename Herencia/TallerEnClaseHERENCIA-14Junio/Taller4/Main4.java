...
public class Main4 {
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (opcion) {
                case 1: // estudiante
                    // Estudiante estudiante   = new Estudiante();  no se coloca aquí porque se estaría creando un objeto nuevo cada vez que se ingresa al case
                    do {
                        bien = true;
                        try {
                            System.out.print("Ingrese su cedula: ");
                ...
                case 2:
                    // Trabajador trabajador   = new Trabajador();   no se coloca aquí porque se estaría creando un objeto nuevo cada vez que se ingresa al case
